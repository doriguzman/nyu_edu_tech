...
const data = [
  ...
  {
    "Number of Concerts per Month": 1,
    "Number of Movies per Month": 8,
    Choice: "A"
  },
  ...
  {
    "Number Of Movies per Month": 10,
    "Number of Concerts per Month": 2,
    Choice: "B"
  },
  {
    "Number of Movies Per Month": 1,
    "Number of Concerts per Month": 3,
    Choice: "C"
  }
];
...
class GraphTwo extends Component {
  ...
  render() {
    ...
    return (
      <div>
       <p>QUESTION 2 <br/> Select a point on the graph where Mark is working according to his budget (working within it) <br/> SELECT POINTS A, B , OR C
        </p>
        <div className="line-chart-wrapper">
          <ResponsiveContainer height={500} width={1000}>
            ...
            >
              <XAxis
                type="number"
                dataKey="Number of Concerts per Month"
                ticks={[1, 2, 3, 4, 5]}
                label={{
                  value: "Number of Concerts per Month",
              ...
              <YAxis
                dataKey="Number of Movies per Month"
                ticks={[0, 2, 4, 6, 8, 10]}
                label={{
                  value: "Number of Movies per Month",
                  position: "left",
                  dy: 10,
                  dx: 20
                }}
    ...
    <Link to='/'> Previous Question</Link>
      </div>
    );
  }
}
